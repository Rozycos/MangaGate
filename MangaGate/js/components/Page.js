...
//     height: "404px",
//     margin: "0 auto",
//     //background: "url(../assets/torii-forest-illustration-1.png)",
//     background: "linear-gradient(0deg, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(../assets/torii-forest-illustration-1.png)", //{background image from db!!}
                ...
                <article>
                    <section className="title__section">
                        <div className="cropped">
                            <img src="../assets/torii-forest-illustration-1.png" alt="torii forest illustration"/> 
                        </div>
                        <h2><span className="title__section--title">Attack on the titans lkjhsdfh asdfh as oaisduioas aosida aoiusduy</span></h2>
